...
namespace Gizmo.Client.UI.Achievement.Module.Pages
{
    ...
    public partial class AchievementsModule : CustomDOMComponentBase
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            Page = pages.FirstOrDefault(p => string.Equals("AF614B09-12B6-4F6B-81C5-B61957404CFB", p.ModuleId.ToString(), StringComparison.OrdinalIgnoreCase));
            if (Page is null) throw new Exception("Achievements page content not found");
